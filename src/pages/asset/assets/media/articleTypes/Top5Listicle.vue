  ...
  <div class="pa-4 text-body" :id="copyID">
    ...
    <div>
      ...
      <Top5Display
        ...
        :isLegacy="isLegacy"
        :headline-text="displayCopy.headline"
        :subhead-text="displayCopy.subhead"
        :description-text="displayCopy.description"
...
// Match Top5Display: a CMS article row alone is not a completed writeup.
...
const { articleStatus, articlePhase, isLegacy } = useArticleStatus(
  hasValidContent,
  feedbackCount,
  articlesRef
);
...
const displayCopy = computed(() => getTop5EmptyStateCopy(assetType.value));

const confirmationCopy = computed(() =>
  resolvePressboxConfirmationCopy("top5", articlePhase.value, assetType.value)
);
