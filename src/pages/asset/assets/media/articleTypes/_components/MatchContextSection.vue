    ...
    <v-expansion-panel-text style="padding-left: 0px; padding-right: 0px">
      <div class="row">
        <div class="col-md-6 mb-3">
          <v-text-field
            :model-value="matchContext.round"
            @update:model-value="updateField('round', $event)"
            label="Round"
            variant="outlined"
            density="compact"
          />
        ...
        <div class="col-md-6 mb-3">
          <v-text-field
            :model-value="matchContext.ground"
            @update:model-value="updateField('ground', $event)"
            label="Ground"
            variant="outlined"
            density="compact"
          />
        ...
        <div class="col-md-6 mb-3">
          <v-text-field
            :model-value="matchContext.tossWinner"
            @update:model-value="updateField('tossWinner', $event)"
        ...
        <div class="col-md-12 mb-3">
          <v-textarea
            :model-value="matchContext.tossResult"
            @update:model-value="updateField('tossResult', $event)"
            label="Who batted First"
            variant="outlined"
            density="compact"
            rows="2"
          />
        ...
        <div class="col-md-12 mb-3">
          <v-textarea
            :model-value="displayResultStatement"
            @update:model-value="updateField('resultStatement', $event)"
            label="What is the current or final result"
            variant="outlined"
            density="compact"
            rows="2"
          />
...
function updateField<K extends keyof MatchContext>(
  field: K,
  value: MatchContext[K]
) {
  // Format resultStatement to add suffix for team name when saving
  if (
    field === "resultStatement" &&
    typeof value === "string" &&
    value.trim()
  ) {
    ...
    const hasTeamToBat = trimmedValue
      .toLowerCase()
      .includes("the team to bat first was");
