  ...
  <div>
    ...
    >
      ...
      <p class="article-body mb-3">
        Please wait whilst we create your Ladder Summary article. This may take
        some time.
      </p>
    ...
    <div v-else class="text-center pa-8">
      <p class="article-body text-bold mb-2">
        Ladder Summary Articles on Demand.
      </p>
      <p class="article-body mb-4">
        Create professional ladder summary articles instantly. Our AI analyzes
        league standings and generates comprehensive summaries that you can
