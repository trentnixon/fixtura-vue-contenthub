  ...
  <div>
    ...
    <div v-if="articleStatus === 'pending'" class="text-center pa-8">
      ...
      <p class="article-body mb-3">
        Please wait whilst we create your Upcoming Fixtures article. This may take some time.
      </p>
    ...
    <div v-else-if="articleStatus === 'completed' && formattedArticles.length > 0">
      ...
      <div v-for="(article, index) in formattedArticles" :key="index" class="mb-4">
        ...
        <div v-for="(fixture, fixtureIndex) in article.fixtures" :key="fixtureIndex" class="mb-4">
          <!-- Fixture Match -->
          ...
          <v-divider v-if="fixtureIndex < article.fixtures.length - 1" class="my-4"></v-divider>
        </div>
