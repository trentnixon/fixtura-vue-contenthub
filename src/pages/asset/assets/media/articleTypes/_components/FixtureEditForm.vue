<template>
  <div class="fixture-edit-form">
    ...
    <div class="mb-4 d-flex align-center justify-space-between">
      ...
      <div class="d-flex align-center">
        <IconButton
          ...
          tooltip="Save changes to this fixture"
          size="small"
          :color="hasChanges ? 'success' : 'grey'"
          @click="$emit('save')"
        />
      </div>
    </div>
    ...
    <div class="mb-4" v-if="editingFixtureData">
      <h2 class="text-title">
        {{ editingFixtureData.homeTeam.teamName }} vs
        {{ editingFixtureData.awayTeam.teamName }}
      </h2>
      <div
        v-if="
          editingFixtureData.matchContext.ageGroup ||
          editingFixtureData.matchContext.grade
        "
    ...
    <v-form v-if="editingFixtureData" ref="formRef">
      <v-expansion-panels
        :model-value="expandedSections"
        @update:model-value="
          $emit('update:expandedSections', $event as number[])
        "
        multiple
        class="mb-4"
      >
